<?php require_once './header.php'; 
  ...
  $get_info = $pdo->prepare("SELECT customers.name,customers.address,customers.phone,customers.email,users.role, users.password, users.profile from customers inner join users on customers.email=users.email where customers.email=:email");
            ...
            <div class="card shadow">
              <div class="card-body box-profile">
                ...
                <div class="text-center profile-pic-div">
                  ...
                  <img class="profile-user-img img-fluid img-circle"  src="<?=$baseurl?>assets/img/profile/<?=$info['profile']?>" alt="User profile picture" id="photo">
