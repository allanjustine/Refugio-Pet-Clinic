...
<script>
  ...
  $('.editBtnAdd').on("click", function() {
    ...
    <td class="td_qty" style="width: 100px"><input onkeydown="return (event.keyCode!=13);" value="0" type="number" min="1" step="1" class="form-control qty" placeholder="Qty" name="new_item_qty[]" required>
    </td>
