...
<head>
  ...
  <title>Pet Clinic | Cashier</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="<?= $baseurl?>assets/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>-->
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="<?= $baseurl?>" class="brand-link">
      <img src="<?= $baseurl?>assets/img/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-0" style="opacity: .8">
    ...
    <div class="sidebar">
     <!-- Sidebar user panel (optional) -->
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img id="sidebar-img" src="<?= $baseurl?>cashier/uploads/img/profile/<?=$info['profile']?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item mt-2" id="nav-dash">
            <a href="<?= $baseurl.'cashier';?>" class="nav-link ">
